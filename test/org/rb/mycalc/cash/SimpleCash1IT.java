 ...
 * @author raitis
 */
public class SimpleCash1IT {
    
    public SimpleCash1IT() {
    }
    ...
    public void testTake() throws InterruptedException {
        ...
        SimpleCash1 cash = new SimpleCash1();
        cash.setTest(true);
    ...
    class CashTask implements Callable<Boolean>{
        ...
        public CashTask(SimpleCash1 cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DCash implements Callable<Boolean>{
        ...
        private final SimpleCash1 cash;
        ...
        public CashTaskVect3DCash(SimpleCash1 cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DRandom implements Callable<Boolean>{
        ...
        public CashTaskVect3DRandom(SimpleCash1 cash, int vectNum) {
            this.cash = cash;
    ...
    public void testTakeByThreads() throws InterruptedException, ExecutionException{
        ...
        for (Future<Boolean> future : futuresList) {
            try {
                ...
                Logger.getLogger(SimpleCash1IT.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
       service.shutdownNow();
    ...
    public void testVect3DCashRandomByThreads() throws InterruptedException, ExecutionException{
        ...
        SimpleCash1 cash = new SimpleCash1(400);
        cash.setTest(false);
        //----//
        int threadNumber =10;
        int vectNumber= 20;
