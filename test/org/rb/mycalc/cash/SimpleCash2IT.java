 ...
 * @author raitis
 */
public class SimpleCash2IT {
    
    public SimpleCash2IT() {
    }
    ...
    public void testTake() throws InterruptedException {
        ...
        SimpleCash2 cash = new SimpleCash2();
        cash.setTest(true);
    ...
    class CashTask implements Callable<Boolean>{
        ...
        public CashTask(SimpleCash2 cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DCash implements Callable<Boolean>{
        ...
        private final SimpleCash2 cash;
        ...
        public CashTaskVect3DCash(SimpleCash2 cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DRandom implements Callable<Boolean>{
        ...
        public CashTaskVect3DRandom(SimpleCash2 cash, int vectNum) {
            this.cash = cash;
    ...
    public void testTakeByThreads() throws InterruptedException, ExecutionException{
        ...
        for (Future<Boolean> future : futuresList) {
            try {
                ...
                Logger.getLogger(SimpleCash2IT.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
       service.shutdownNow();
    ...
    public void testVect3DCashRandomByThreads() throws InterruptedException, ExecutionException{
        ...
        SimpleCash2 cash = new SimpleCash2(400);
        cash.setTest(false);
        //----//
        int threadNumber =10;
        int vectNumber= 20;
