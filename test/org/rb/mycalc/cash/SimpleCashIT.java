...
public class SimpleCashIT {
    ...
    class CashTask implements Callable<Boolean>{
        ...
        public CashTask(SimpleCash cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DCash implements Callable<Boolean>{
        ...
        public CashTaskVect3DCash(SimpleCash cash) {
            this.cash = cash;
        }
    ...
    class CashTaskVect3DRandom implements Callable<Boolean>{
        ...
        public CashTaskVect3DRandom(SimpleCash cash, int vectNum) {
            this.cash = cash;
    ...
    public void testTakeByThreads() throws InterruptedException, ExecutionException{
        ...
        for (Future<Boolean> future : futuresList) {
            try {
                ...
                Logger.getLogger(SimpleCashIT.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
       service.shutdownNow();
    ...
    public void testVect3DCashRandomByThreads() throws InterruptedException, ExecutionException{
        ...
        SimpleCash cash = new SimpleCash(400);
        cash.setTest(false);
        //----//
        int threadNumber =10;
        int vectNumber= 20;
